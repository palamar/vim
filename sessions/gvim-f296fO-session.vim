...
set shortmess=aoO
badd +19 ~/Work/dev/bigmir/i.bigmir.net/a/photo2/js/photoView2.js
badd +86 ~/Work/dev/bigmir/templates/photo2/album_photoView.tpl
badd +200 config.dev.php
silent! argdel *
edit ~/.vimprojects
...
exe '3resize ' . ((&lines * 8 + 12) / 24)
exe 'vert 3resize ' . ((&columns * 67 + 40) / 80)
exe '4resize ' . ((&lines * 11 + 12) / 24)
...
14723
normal zo
let s:l = 14725 - ((14724 * winheight(0) + 11) / 22)
...
wincmd w
argglobal
edit ~/Work/dev/bigmir/templates/photo2/album_photoView.tpl
lnoremap <buffer> " ›
lnoremap <buffer> # π
lnoremap <buffer> $ ;
lnoremap <buffer> & ?
...
wincmd w
argglobal
edit ~/Work/dev/bigmir/i.bigmir.net/a/photo2/js/photoView2.js
lnoremap <buffer> " ›
lnoremap <buffer> # π
lnoremap <buffer> $ ;
lnoremap <buffer> & ?
